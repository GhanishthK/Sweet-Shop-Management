...
export const EditSweetModal: React.FC<EditSweetModalProps> = ({ sweet, onClose, onSubmit }) => {
    ...
    >
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <h2 style={{ margin: 0, fontSize: '20px', fontWeight: 'bold' }}>Edit Sweet</h2>
          <button
            onClick={onClose}
            style={{
              background: 'none',
